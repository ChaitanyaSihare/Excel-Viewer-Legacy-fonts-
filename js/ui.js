...
// ---- Sheet rendering ----
    ...
    function buildRowHTML(r, spanInfo, jsonData, maxCols, cellFonts, forceEnglish, formulaCells) {
      let rowHTML = '<tr>';
      for (let c = 0; c < maxCols; c++) {
        ...
        if (forceEnglish) {
          ...
          if (viewMode === 'unicode') {
            ...
            const needsConversion = knownFont ? isLegacyFontName(knownFont) :
          ...
          } else if (knownFont && isLegacyFontName(knownFont)) {
    ...
    function renderMoreRows(count) {
      ...
      for (let r = renderState.nextRow; r < end; r++) {
        html += buildRowHTML(r, renderState.spanInfo, renderState.jsonData, renderState.maxCols, renderState.cellFonts, renderState.forceEnglish, renderState.formulaCells);
      }
    ...
    function renderSheet(sheetName) {
      ...
      renderState = { jsonData, spanInfo, cellFonts, formulaCells, maxCols, numRows, nextRow: 0, forceEnglish: englishSheets.has(sheetName) };
